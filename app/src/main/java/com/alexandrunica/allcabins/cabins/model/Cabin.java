...
public class Cabin implements Serializable {
    ...
    public Cabin(String id, String name, String address, String location, String state, String city, String country, String phone, String email, String price, float rating, String thumbPhotoUrl, String description, String facilities, String idAdded, String cabinInfo, HashMap<String, String> uploadedPictures, HashMap<String, String> reviews, HashMap<String, String> pictures, double distance) {
        this.id = id;
        this.name = name;
